...
def carregar_dados():
    ...
    df_vendas = pd.read_excel(r"C:\Users\emmanueltorres\Downloads\Scripts\streamlit\app_vendas\Vendas.xlsx")
    df_produtos = pd.read_excel(r"C:\Users\emmanueltorres\Downloads\Scripts\streamlit\app_vendas\Produtos.xlsx")
